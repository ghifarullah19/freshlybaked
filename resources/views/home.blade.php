...
@section('container')
    ...
    <div class="container mx-auto pt-20 mb-24" id="highlight">
        ...
        <div class="flex flex-row justify-center mt-3">
            <button  onclick="window.location.href='products'" class=" px-4 md:px-6 lg:px-8 py-2 md:py-3 lg:py-3 xl:py-4 bg-[#454545] text-white rounded-full hover:bg-[#b57810] focus:outline-none focus:shadow-outline-yellow active:bg-[#f59918] font-bold mx-auto">Shop Now ➲</button>
        </div>
    </div>
    {{-- Akhir Highlight --}}
            ...
            <div class="lg:w-1/3 md:w-1/2 bg-[#BD9354] rounded-lg p-6 flex flex-col md:ml-auto w-1/2 mt-10 md:mt-0 relative z-10 shadow-md">
                ...
                <form name="Freshlybaked-Contactform">
                    <div class="relative mb-4">
                        ...
                        <input type="text" id="name" name="nama" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="Masukan Nama Anda" required>
                    </div>
                    <div class="relative mb-4">
                        <label for="email" class="leading-7 text-sm text-white">Email</label>
                        <input type="email" id="email" name="email" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder="Masukan Email Anda" required>
                    </div>
                    <div class="relative mb-4">
                        <label for="message" class="leading-7 text-sm text-white">Message</label>
                        <textarea id="message" name="pesan" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out" placeholder="Masukan Pesan Anda"></textarea>
                    </div>

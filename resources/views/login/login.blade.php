    ...
    <div class="flex items-center justify-center min-h-full">
        <div class="bg-gray-900 bg-opacity-60  rounded-lg shadow p-8 w-full max-w-md justify-center">
            ...
            <div class="align-middle block">
                <button href="{{ route('google.login') }}" class="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-white relative">
                    ...
                    <span class="block right-2 text-white">Sign in with Google</span>
                </button>
            </div>

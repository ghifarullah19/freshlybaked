...
<section class="mt-8">
    <div class="container mx-auto">
        <h2 class="text-3xl font-bold mb-8 text-center mt-28">About Developer</h2>
        
        <div class="flex flex-wrap justify-center mb-8">

            <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-[#9E7540] dark:text-gray-100 mx-2 my-2">
                ...
                <div class="space-y-4 text-center divide-y dark:divide-gray-700">
                    <div class="my-2 space-y-1">
                        <h2 class="text-base font-semibold sm:text-base">Muhammad Lutfi Amin G</h2>
                        <p class="px-5 text-xs sm:text-base dark:text-gray-300">Project Manager</p>
                    </div>
                    <div class="flex justify-center pt-2 space-x-4 align-center">
                        <a href="#" aria-label="Instagram" class="p-2 rounded-md dark:text-gray-100">
                        ...
                        <a href="#" aria-label="Facebook" class="p-2 rounded-md dark:text-gray-100">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18" height="18" viewBox="0,0,256,256">
                        ...
                        <a href="#" aria-label="Email" class="p-2 rounded-md dark:text-gray-100">
            ...
            <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-[#9E7540] dark:text-gray-100 mx-2 my-2">
                ...
                <div class="space-y-4 text-center divide-y dark:divide-gray-700">
                    <div class="my-2 space-y-1">
                        <h2 class="text-base font-semibold sm:text-base">Ainan Bahrul Ihsan</h2>
                        <p class="px-5 text-xs sm:text-base dark:text-gray-300">Back-end Developer</p>
                    </div>
                    <div class="flex justify-center pt-2 space-x-4 align-center">
                        <a href="#" aria-label="Instagram" class="p-2 rounded-md dark:text-gray-100">
                            <svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
            ...
            <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-[#9E7540] dark:text-gray-100 mx-2 my-2">
                ...
                <div class="space-y-4 text-center divide-y dark:divide-gray-700">
                    <div class="my-2 space-y-1">
                        <h2 class="text-base font-semibold sm:text-base">Gilang Ramadhan</h2>
                        <p class="px-5 text-xs sm:text-base dark:text-gray-300">Front-end Developer</p>
                    </div>
                    <div class="flex justify-center pt-2 space-x-4 align-center">
                        <a href="#" aria-label="Instagram" class="p-2 rounded-md dark:text-gray-100">
                            <svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
            ...
            <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-[#9E7540] dark:text-gray-100 mx-2 my-2">
                ...
                <div class="space-y-4 text-center divide-y dark:divide-gray-700">
                    <div class="my-2 space-y-1">
                        <h2 class="text-base font-semibold sm:text-base">Fauzi Ilyas Nuryadi</h2>
                        <p class="px-5 text-xs sm:text-base dark:text-gray-300">Front-end Developer</p>
                    </div>
                    <div class="flex justify-center pt-2 space-x-4 align-center">
                        <a href="#" aria-label="Instagram" class="p-2 rounded-md dark:text-gray-100">

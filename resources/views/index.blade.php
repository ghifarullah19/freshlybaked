...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4">Si Apih Freshly Backed</h1>
        <p class="lead">Baking Private & Made by Order</p>
      </div>
    </div>
  </section>
    <!-- akhir jumbotron -->
      ...
      <section id="about">
        <div class="container">
          <div class="about text-center">
            ...
            <div class="row">
              <div class="col">
                <div class="about-apih" data-aos="fade-up">
                  <img
                    src="img/siapih1.jpg"
                    alt="yadi"
                    width="200"
          ...
          <div class="container ">
            ...
            <div class="card-deck">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Cold Cheese Cake</h5>
                  <p >
                    <a href="" class="card-text">View</a>
                  </p>

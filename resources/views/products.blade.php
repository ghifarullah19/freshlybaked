    ...
    <div class="relative">
        ...
        <form action="/products" method="get">
            ...
            <div class="flex flex-row gap-3">
                ...
                {{-- Search Input --}}
                <input type="search" id="search" class="block w-full p-4 ps-4 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-white dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search something..." name="search1" value="{{ request("search") }}" onfocus="this.value=''">

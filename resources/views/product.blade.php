            ...
            <div class="md:flex-1 px-4">
                ...
                <form class="max-w-xs mt-7">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <input type="text" id="counter-input" data-input-counter class="flex-shrink-0 text-black border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value="12" required>

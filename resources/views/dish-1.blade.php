  ...
  <body>
    ...
    <!-- akhir navbar -->
      ...
      <section id="dish-1">
        <div class="dish-1">
          <div class="container">
            <h2 class="dish-title">Cake & Dessert</h2>
            <div class="row">
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="img/1.jpg" alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title">Chocolate Trufle Cake</h5>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Cold Chesse Cake</h5>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Chocolate Trufle</h5>
                          <a href="#" class="btn btn-primary">Available</a>
                        </div>
                      </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Chocolate Macaro
                          <a href="#" class="btn btn-primary">Available</a>
                        </div>
                      </div>
                </div>
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Glutinous Rice n Chocolate Cake</h5>
                          <a href="#" class="btn btn-danger">Out of Order</a>
                        </div>
                      </div>
                </div>
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          <h5 class="card-title">Strawberry Dessert</h5>
                          <a href="#" class="btn btn-primary">Available</a>
                        </div>
                      </div>
                </div>

        ...
        <div class="bg-black bg-opacity-80 rounded-lg shadow p-8 w-full max-w-md justify-center">
            ...
            <form class="max-w-sm mx-auto" action="/register/google" method="POST">
                ...
                <div class="mb-5">
                  ...
                  <input type="text" id="name" name="name" class="text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 shadow-sm-light" placeholder="John Doe" required value="{{ $google_user['name'] }}" required readonly>
                </div>
                @error('name')
                ...
                <div class="mb-5">
                  ...
                  <input type="email" id="email" name="email" class="text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-800 focus:border-blue-800 shadow-sm-light" placeholder="name@email.com" required value="{{ $google_user['email'] }}" readonly>
                </div>
                @error('email')
                    <div class="p-4 mb-4 text-sm bg-gray-800 text-red-400" role="alert">
                        <span class="font-medium">Danger alert!</span>

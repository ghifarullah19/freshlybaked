              ...
              <body>
                ...
                <!-- akhir navbar -->
                  ...
                  <section id="dish-2">
                    <div class="dish-2">
                      <div class="container">
                        <h2 class="dish-title">Signature</h2>
                        <div class="row">
                            <div class="col">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="img/12.jpg" alt="Card image cap">
                                    <div class="card-body">
                                      <h5 class="card-title">Chocolate Showpiece</h5>
                                      <!-- <p class="card-text">Some quick example text to build on the card title Availableand make up the bulk of the card's content.</p> -->
                            ...
                            <div class="col">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="img/22.jpg" alt="Card image cap">
                                    <div class="card-body">
                                      <h5 class="card-title">Chocolate Showpiece: The Dragon</h5>
                            ...
                            <div class="col">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="img/24.jpg" alt="Card image cap">
                                    <div class="card-body">
                                      <h5 class="card-title">Bread Showpiece: Ramadhan</h5>
                                      <!-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> -->
                                      <a href="#" class="btn btn-primary">Available</a>
                                    </div>
                                  </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                      <h5 class="card-title">Bread Showpiece: Gong Xi Fa Cai</h5>
                                      <!-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> -->
                                      <a href="#" class="btn btn-danger">Out of Order</a>
                                    </div>
                                  </div>
                            </div>
                        </div>

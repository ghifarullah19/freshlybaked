...
<section class="overflow-hidden bg-[#FAEED1] font-poppins sm:py-4">
  <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
    <button onclick="window.location.href='/dashboard/products'" class="mr-1 mb-5 block text-white bg-[#994D1C] hover:bg-[#E48F45] focus:ring-4 focus:outline-none focus:ring-[#994D1C] font-medium rounded-lg text-sm px-5 py-2.5 text-center h-fit" type="button">
      Back
    </button>

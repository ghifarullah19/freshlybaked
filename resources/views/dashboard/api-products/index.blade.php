                ...
                @endif
                   ...
                   {{-- modal button product --}}
                    ...
                    <div class="flex flex-row">
                        <form action="/dashboard/api-products/get" method="get">
                            <button data-modal-target="modal-product" class="mr-1 block text-white bg-[#994D1C] hover:bg-[#E48F45] focus:ring-4 focus:outline-none focus:ring-[#994D1C] font-medium rounded-lg text-sm px-5 py-2.5 text-center h-fit" type="submit">
                                Tambah Data
                            </button>
                        </form>
                       {{-- end modal toggle --}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-6 ml-10 my-2 py-1 inline-flex bg-transparent">
                                    ...
                                    <button onclick="window.location.href='/dashboard/api-products/{{ $menu->strSlug }}/edit'" type="submit" class="px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border-t border-b border-gray-900 hover:bg-amber-400 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white">
                                    ...
                                    <form action="/dashboard/api-products/{{ $menu->strSlug }}" method="POST">
                                        @csrf
                                        @method('delete')
